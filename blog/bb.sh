...
global_variables() {
    ...
    # Blog title
    global_title="not a blog"
    # The typical subtitle for each blog
    global_description="By someone too busy to write one"
    # The public base URL for this blog
    global_url="https://wuzzard.com/blog"

    # Your name
    global_author="Conlin Durbin"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://wuzzard.com" 
    # Your email
    global_email="sup@wuzzard.com"
